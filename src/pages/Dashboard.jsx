    ...
    <>
      ...
      <div className="font-quickSand overflow-hidden  bg-zinc-100">
        ...
        <div className="hidden mt-20 lg:block relative ">
          <div className="relative overflow-hidden mt-8 mx-28 h-72 bg-[url('/images/poster.svg')] bg-cover bg-no-repeat bg-center rounded-xl before:content-[''] before:absolute before:top-0 before:bottom-0 before:left-0 before:right-0 before:bg-gradient-to-r from-crem from-25%">
            <div className="absolute top-16 left-16">
              <h1 className="mb-2 text-4xl italic text-white font-bold">
                Diskon Hari Ini!
              </h1>
              <h1 className="text-4xl italic text-primary font-bold">85%</h1>
            </div>
          </div>
        ...
        <div className="-translate-y-24 lg:-translate-y-24 ">
          ...
          >
            <h1 className="hidden lg:block text-lg font-bold mb-6">
              ...
              <span className="text-primary">AirTix!</span>
            </h1>
