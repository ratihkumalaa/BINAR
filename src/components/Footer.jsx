...
function Footer() {
  return (
    <div className="bg-primary flex flex-col mt-20 p-3 pb-36 lg:p-10 font-quickSand">
      {/* Level 1 */}
      ...
      <span className="hidden lg:block h-[1px] my-8 w-full bg-primary"></span>
      ...
      <div className="mt-6 flex flex-col lg:item gap-3">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-center gap-2 lg:gap-10 text-sm text-secondary font-medium lg:font-bold lg:uppercase ">
      ...
      {/* Level 3 */}
      <h1 className="mt-10 text-zinc-500 text-sm text-left lg:text-center font-medium">Copyright© 2023 Team 7. All right reserved</h1>
      {/* Level 3 End */}
    </div>
  );
}
